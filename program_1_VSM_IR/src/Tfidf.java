 ...
 */
    public class Tfidf {
        ...
        public static String readFile(String file) throws FileNotFoundException, IOException
        {
            ...
            InputStreamReader inStrR = new InputStreamReader(new FileInputStream(file), "utf8"); //byte streams to character streams
...
//            DisTfIdf(resTfIdf);
        ...
        public static void main(String[] args) throws IOException {
            String file = "D:\\WORKDoc\\CIRB010\\CIRB010\\cdn";
            HashMap<String,HashMap<String, Float>> all_tf = tfAllFiles(file);
            System.out.println("tf"+all_tf);
            HashMap<String, Float> idfs = idf(all_tf);

            System.out.println("idfs"+idfs);
            tf_idf(all_tf, idfs);
        }
